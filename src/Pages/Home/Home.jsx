  ...
  return (
    <div>
      ...
      <section className="px-44 py-20 m-0 text-blue-900 h-[100vh] bg-cover bg-center bg-[url('/back.jpg')]">
        <div  className="relative  border-2 border-transparent mt-auto p-6 bg-white/30 rounded-lg h-[400px] shadow-lg backdrop-blur-md flex flex-col items-center py-32">
...
<div className="text-center container mx-auto">
  <section className="mt-16">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      <div className="h-[150px] rounded-lg cursor-pointer border hover:bg-transparent transition-all duration-300">
        <div className="px-4 py-6 md:px-6 md:py-8 h-full w-full bg-gray-100 rounded-lg shadow border hover:bg-transparent transition-all duration-300">
          <h4 className="text-lg md:text-xl font-bold">Matematika</h4>
          <p className="text-sm md:text-base">Hisoblash va mantiq asoslari.</p>
        </div>
      </div>
      <div className="cursor-pointer h-[150px] border rounded-lg hover:bg-transparent transition-all duration-300">
        <div className="px-4 py-6 md:px-6 md:py-8 h-full w-full bg-gray-100 rounded-lg shadow hover:bg-transparent transition-all duration-300">
          <h4 className="text-lg md:text-xl font-bold">Fizika</h4>
          <p className="text-sm md:text-base">Tabiat qonuniyatlarini o‘rganing.</p>
        </div>
      </div>
      <div className="cursor-pointer h-[150px] border rounded-lg hover:bg-transparent transition-all duration-300">
        <div className="px-4 py-6 md:px-6 md:py-8 h-full w-full bg-gray-100 rounded-lg shadow hover:bg-transparent transition-all duration-300">
          <h4 className="text-lg md:text-xl font-bold">Dasturlash</h4>
          <p className="text-sm md:text-base">Python, JavaScript va boshqalar</p>
        </div>
      </div>
      <div className="cursor-pointer h-[150px] rounded-lg">
        <div className="px-4 py-6 md:px-6 md:py-8 h-full w-full border bg-gray-100 rounded-lg shadow hover:bg-transparent transition-all duration-300">
          <h4 className="text-lg md:text-xl font-bold">Falsafa</h4>
          <p className="text-sm md:text-base">Ong, Tafakkur va manipulyatsya</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2  lg:grid-cols-3 gap-6 mt-6">
    <div data-aos="fade-up" className="p-6">
      <h4 className="text-lg md:text-xl font-bold">Eng yaxshi darslar</h4>
      <p className="text-sm md:text-base">Sifatli va tushunarli ma’lumotlar.</p>
      <img className="mt-6 md:mt-12 rounded-lg" src={Dars} alt="dars" />
    </div>
    <div data-aos="fade-up" className="p-6">
      <h4 className="text-lg md:text-xl font-bold">Yangi texnologiyalar</h4>
      <p className="text-sm md:text-base">Ilmiy va zamonaviy fanlar.</p>
      <img className="mt-6 md:mt-12 rounded-lg" src={Tex} alt="Tex" />
    </div>
    <div data-aos="fade-up" className="p-6">
                  ...
                  <div>
                    ...
                    <div data-aos="fade-left" className="relative">
                      ...
                      <p className="text-gray-600 relative z-10 leading-relaxed text-left mb-6">
                        Dunyoda minglab o’zbek yoshlariga qo’l mehnati emas,
                        yuqori intellekti uchun haq to'lansa, millionlab yoshlar
                        o'z oilalaridagi moliyaviy ahvolni o'nglab, chet elda
                        qiynalib ishlayotgan yaqinlarini vatanga qaytishiga
                        sababchi bo'lsa va dunyoni yaxshi tarafga o'zgartiruvchi
                        qarorlar qabul qiladigan, gigant kompaniyalarning
                        boshqaruv pozitsiyasini egallaydigan mutaxassislarni
                        yetishtira olsak, o'z oldimizga qo'ygan maqsadlarimizga
                        erishgan bo'lamiz.
                      </p>
                    </div>
                  </div>
          ...
          <div data-aos="fade-up" className="relative">
            <div className="w-[300px] h-[300px] lg:w-[400px] lg:h-[400px] rounded-full overflow-hidden border-8 border-teal-400">
              ...
              <div className="flex-1 max-w-2xl">
                ...
                >
                  Bizning maqsadimiz - kuchli akademik salohiyatimizdan to'g'ri
                  foydalangan holda, davlatimiz taraqqiyotida ahamiyatli bo'lgan
                  ilmiy-texnologik yechimlarni yaratadigan va dunyo miqyosida
                  nufuzli IT kompaniyalarda ishlab keta oladigan, malakali IT
                  mutaxassislarni tayyorlash va yorqin shaxslarni
                  shakllantirish.
                </p>
